...
image_path = r'C:\Users\Manthan\Desktop\CV_DL_Practicals\filtering_threshold_otsu_watershed_images_region_growing\train_020.png'  # Change this to the path of your image
...
segmented_image = region_growing(bilateral, seed_point, threshold=140)
